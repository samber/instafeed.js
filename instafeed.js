	  ...
	  if ((typeof document !== "undefined" && document !== null) && this.options.mock === false) {
		...
		if ((this.options.template != null) && typeof this.options.template === 'string') {
		  ...
		  for (_j = 0, _len1 = images.length; _j < _len1; _j++) {
			...
			// Modified by Samuel BERTHE <dev@samuel-berthe.fr>
			// Company : www.emotic.fr
			// 27.12.2013
			if (image.type && image.type == "video") {				// video
			  	if (this.options.resolution == "thumbnail") {		// thumb
					...
					src.src = image.videos[this.options.resolution].url;
					src.type = "video/mp4";
